...
public class MyGameController extends GameController {
    ...
    public void init() throws SlickException {
        super.init();
        this.backgroundManager.addComponent(EBackground.MAP_1, new WallpaperSliding(ResourceManager.get().getBackgroundAnimator(EBackground.MAP_1), 30, true, true));
        this.backgroundManager.addComponent(EBackground.FINAL_SCREEN, new WallpaperSliding(ResourceManager.get().getBackgroundAnimator(EBackground.MAP_1), 30, true, true));
    }
